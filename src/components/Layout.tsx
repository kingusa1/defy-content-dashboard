...
import defyLogo from '../assets/defy-logo.svg';
            ...
            <aside className={`${sidebarOpen ? 'w-64' : 'w-20'} bg-[#1b1e4c] flex flex-col transition-all duration-300 ease-in-out`}>
                ...
                <div className="p-6 border-b border-white/10">
                    <div className="flex items-center gap-3">
                        {sidebarOpen ? (
                            <img src={defyLogo} alt="Defy Insurance" className="h-10 w-auto" />
                        ) : (
                            <img src="/defy_logo.png" alt="Defy" className="w-10 h-10 rounded-xl object-contain" />
                        )}
                    </div>
                </div>
                        ...
                        <div className="relative">
                            ...
                            >
                                ...
                                <div className="text-left hidden md:block">
                                    <p className="text-sm font-semibold text-slate-700">Ramy Sharaf</p>
...
const NavItem: React.FC<NavItemProps> = ({ icon, label, active = false, badge, collapsed = false }) => (
    ...
    >
        ...
        {!collapsed && badge && (
            <span className={`px-2 py-0.5 text-xs font-bold rounded-full ${active ? 'bg-white/20 text-white' : 'bg-[#13BCC5]/20 text-[#13BCC5]'}`}>
                {badge}
            </span>
        )}
    </button>
